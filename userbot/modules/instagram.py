...
# Kalo Clone Ini Jangan dihapus ya anjg nanti Ngamuk, Ok Mksh Sma Sma
...
async def insta(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await event.edit("`Mohon Buka Blokir` @Instagram_DlRobot `Lalu Coba Lagi`")
            return
